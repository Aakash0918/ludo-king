    ...
    <div class="dash-content">
        <div class="youtube">
            <button class="youtube-help">
                <div class="icon">
                    <div>
                        <svg viewBox="0 0 24 24" width="20" height="20" stroke="#f00" stroke-width="2" fill="none"
    ...
    <div class="footer-content">
        ...
        <div class="foot-content">
            ...
            <p>Ludo is a skill-based real-money gaming platform accessible only for our users in India.
                It is accessible on <a href="mailto:info@ludo.com">info@ludo.com</a>. On Ludo, users can compete for
                real cash in
